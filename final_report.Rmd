...
The Google Trends portion of the project was motivated in part by Seth Stephens-Davidowitz's bestselling book *Everybody Lies*. Stephens-Davidowitz, a data scientist previously affiliated with Google, used Google Trends data to study the 2012 and 2016 presidential elections. His research questions included the prediction of voter turnout in crucial geographic regions, the impact of racism on Barack Obama's election underperformance compared to polling-based predictions, and identifying queries with prediction value for Donald Trump's election performance compared to Hillary Clinton's. 
