...
Pennsylvania has one of the last primaries (April 28th), which means polling data may not accurately reflect the ultimate outcome of voter choices, especially when considering that outcomes in early states may change the tides for specific individuals. Some candidates are therefore showing a lack of variability in current polling results, including Biden and Buttigieg, which may signify that voters are more consistent in percieving them to maintain their current positions of first and fourth respectively, while not being as certain how Sanders and Warren will finish. However, the overall field is exhibiting a similar trend to Iowa, as Biden leads the way a median of `r median(y)` percentage points among sampled polls. He is followed by Sanders and Warren, who again are polling quite close together at a median of 9.5 and 8 percentage points, respectively. Buttigieg does not trail by much any longer, as he is showing a median of `r median(x)` percentage points. This means that the 2nd through 4th place candidates are all within 3 points of each other.
