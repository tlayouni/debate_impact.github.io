...
Of the top three candidates in the most recent poll on November 3, 2019, only Joe Biden has both a large number of endorsements. Both Elizabeth Warren and Bernie Sanders have a low number of endorsements but are polling around 20%. For candidates who are near the bottom of the pack, between 1% and 5%, the relationship between the number of endorsement and polling performance appear to be consistent with the exception of Kamala Harris.
