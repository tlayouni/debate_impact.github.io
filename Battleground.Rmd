...
president_primary_polls %>%
  ...
  plot_ly(y = ~pct, color = ~answer, type = "box", colors = "Set3")
IA_plotly
```

Median polling results for leading candidates show Biden still ahead of the pack with 25 percentage points but also a large range of 20 points between lowest and highest predictions. Warren follows in second in the polls and with a similarly wide range of 19 points. Just a 2 percentage point difference between Warren and Sanders may signify a tight race. Buttigieg continues to lag behind these three but remains in double digits with 13 points, all the while exhibiting the lowest range in polls at only 9.6 between .
...
Pennsylvania has one of the last primaries (April 28th), which means polling data may not accurately reflect the ultimate outcome of voter choices, especially when considering that outcomes in early states may change the tides for specific individuals. Some candidates are therefore showing a lack of variability in current polling results, including Biden and Buttigieg. However, the overall field is exhibiting a similar trend to Iowa, as Biden leads the way with his highest polling result at 46 percentage points among sampled polls. He is followed by Sanders and Warren, who again are polling quite close together at a median of 9.5 and 8 percentage points, respectively. Buttigieg trails the field, with his highest result in the sampled polls at 8.5 percentage points.
...
Between Iowa and Pennsylvania, there are consistent spikes in search queries for the three leading candidates: Biden, Sanders, and Warren. Not only does each individual's proportion of hits spike at similar time points in each state, but spikes for all three candidates seem to coincide, suggesting that voters are engaging in general political searches at similar times. Sanders experienced significant popularity in search results in early spring and in October, the latter of which likely around the time of the fourth debate. Biden experienced his greatest spikes in voter search results later in the spring compared to Sanders, closer to the time of debate 1 in June. Warren did not exhibit any significant spikes in search queries but has seen a steady increase in searches over time, at least in Iowa. Both Biden and Sanders have also expereinced steady overall increases in Iowa voter search queries over time, while in Pennsylvania they've ultimately leveled off. All three jumped in searches around the third debate in July. Butigieg however has not been prominent in search queries at any point over the course of the year in either state, despite his recent positive polling results in Iowa.