...
poll_data %>% 
  ...
  #scale_x_date(date_breaks = "1 month", breaks = c("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December")) +
  labs(
    x = "Date",
    y = "Polling Percent",
